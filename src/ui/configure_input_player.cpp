...
#include "configure_mouse_panning.h"
#include "input_profiles.h"
#include "limitable_input_dialog.h"

namespace {
Settings::NativeMouseButton::Values QtButtonToMouseButton(Qt::MouseButton button) {
    switch (button) {
    case Qt::LeftButton: return Settings::NativeMouseButton::Left;
    case Qt::RightButton: return Settings::NativeMouseButton::Right;
    case Qt::MiddleButton: return Settings::NativeMouseButton::Middle;
    case Qt::ForwardButton: return Settings::NativeMouseButton::Forward;
    case Qt::BackButton: return Settings::NativeMouseButton::Back;
    default: return Settings::NativeMouseButton::Left;
    }
}
}
...
ConfigureInputPlayer::ConfigureInputPlayer(QWidget* parent, std::size_t player_index_,
    ...
    auto* continuous_pump_timer = new QTimer(this);
    connect(continuous_pump_timer, &QTimer::timeout, this, [this] {
        input_subsystem->PumpEvents();
    });
    continuous_pump_timer->start(16);
...
void ConfigureInputPlayer::mousePressEvent(QMouseEvent* event) {
    ...
    input_subsystem->GetMouse()->PressButton(0, 0, static_cast<InputCommon::MouseButton>(button));
