...
ConfigureInput::ConfigureInput(Core::HID::HIDCore& hid_core_, QWidget* parent)
    : QWidget(parent), ui(std::make_unique<Ui::ConfigureInput>()),
      profiles(std::make_unique<InputProfiles>()), hid_core{hid_core_} {
    ui->setupUi(this);
}
...
void ConfigureInput::Initialize(InputCommon::InputSubsystem* input_subsystem,
    ...
    const bool is_powered_on = false;
    player_controllers = {
    ...
    connect(ui->vibrationButton, &QPushButton::clicked,
            [this] { CallConfigureDialog<ConfigureVibration>(*this, hid_core); });
